...
// Initial Arrays:
const aquaticAnimals = ["otter", "shark", "bluefin tuna", "snake","crocodile"];
const rainforestAnimals = ["orang-utan", "elephant", "snake","crocodile"];

let awesomeAnimals = [...aquaticAnimals, ...rainforestAnimals];

let animalSet = new Set(awesomeAnimals)

awesomeAnimals = [...animalSet]
